...
function() {
    ...
    a.MediaPlayer.prototype = {
        ...
        buildTimeline: function() {
            ...
            e = !1,
            f = c.slider.offsetLeft,
            g = b(c.slider, "width"),
            h = function(a) {
                var d,
                b = 0;
                d = a.changedTouches ? a.changedTouches[0].pageX: a.pageX,
                c.media.duration && (f > d ? d = f: d > g + f && (d = g + f), b = (d - f) / g * c.media.duration, e && b !== c.media.currentTime && (c.media.currentTime = b))
            },
            ...
            function(a) {
                ...
                f = c.slider.offsetLeft,
                g = b(c.slider, "width"),
                c.slider.addEventListener("touchmove", h),
                c.slider.addEventListener("touchend", 
                function() {
                    e = !1,
                    c.slider.removeEventListener("touchmove", h)
                })
            ...
            function(a) {
                ...
                f = c.slider.offsetLeft,
                g = b(c.slider, "width"),
                c.slider.addEventListener("mousemove", h),
            ...
            function() {
                e || c.slider.removeEventListener("mousemove", h)
            }),
